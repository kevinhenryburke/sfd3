...
export default class bzPanel extends LightningElement {
    ...
    handleCustomEvent(eventData) {
        ...
        console.log("bzPanel: handleCustomEvent topic = ", topic);
        console.log("bzPanel: handleCustomEvent configController = ", this.configController, "eventController", eventController);

        if ( this.configController != eventController){
            return;
        }
    ...
    renderedCallback() {
        ...
        Promise.all([
            ...
            .then(() => {
                bzutils.log("bzPanel: bzutils: loaded common libs");
            })
            .catch(error => {
                this.dispatchEvent(
                    new ShowToastEvent({
    ...
    extractDisplayValuesImpl (data) {
        ...
        console.log("bzPanel.extractDisplayValuesImpl",JSON.stringify(data));
        ...
        if (data != null && data["fields"] != null) {
            ...
            for (let i = 0; i < fields.length; i++) {
                let field = fields[i];
                console.log("bzPanel field.api: " + field.api + " " + field.display + " " + field.fieldType + " /field:  " , field);
            ...
            console.log("bzPanel.extractDisplayValuesImpl returning",displayValuesArray);
    ...
    extractRecordRoleField (data, role) {
        ...
        console.log("bzPanel.extractRecordRoleField",JSON.stringify(data));
